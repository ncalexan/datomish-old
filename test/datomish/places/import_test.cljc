...
(deftest-async test-import
  (with-tempfile [t (tempfile)]
    (let [places (<? (s/<sqlite-connection "/Users/nalexander/Mozilla/tofino/places.sqlite"))
          conn (<? (d/<connect t))]
      (try
...
#_ [
    (def places (<?? (s/<sqlite-connection "/Users/nalexander/Mozilla/tofino/places.sqlite")))
    (def conn (<?? (d/<connect "/Users/nalexander/testkb.sqlite")))
